...
with main_body_col1:
    ...
    with image_col1:
        ...
        new_svg_loader(name="s", left=15, top=-13, height=215, width=220)
        st.write("\n"
                 "                <center>\n"
        ...
        new_svg_loader(name="d", top=-13, left=15, height=215, width=220)
        st.write("\n"
                 "            <center>\n"
    ...
    with image_col2:
        ...
        new_svg_loader(name="q", top=-13, left=15, height=210, width=220)
        st.write("\n"
                 "                    <center>\n"
        ...
        new_svg_loader(name="c", left=15, top=-13, height=215, width=220)
        st.write("\n"
                 "                    <center>\n"
